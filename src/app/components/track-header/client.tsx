...
type ClientTrackHeaderProps = {
  trackData: TrackData;
};

function ClientTrackHeader({ trackData }: ClientTrackHeaderProps) {
  useEffect(() => {
    window.history.replaceState(
      null,
      "",
      `/catalog/${encodeURIComponent(trackData.artists[0])}/discography/${encodeURIComponent(trackData.albumName)}/${encodeURIComponent(trackData.name)}`,
    );
          ...
          <div className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
            <div className="flex flex-col items-center">
              ...
              <div className="mt-1 flex gap-1">
                {trackData.artists.map((name, index) => {
              ...
              <div className="-mt-4 mb-3">
                <TopGenres
                  ...
                  pollsterUrl={`/catalog/${encodeURIComponent(trackData.artists[0])}/${encodeURIComponent(trackData.name)}/genres`}
                />
              </div>
...
export default ClientTrackHeader;
