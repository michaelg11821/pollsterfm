  ...
  return (
    <div className="content-wrapper px-5 py-0 xl:p-0">
      ...
      >
        <div
          className={cn(
            "skeleton shrink-0 animate-pulse overflow-hidden",
            isArtist
        ...
        >
          <div className="flex flex-col justify-between gap-4 md:flex-row md:items-end">
            ...
            >
              <div className="skeleton h-6 w-16 animate-pulse rounded" />
              <div
                className={cn(
              ...
              <div className="flex gap-2">
                ...
                <div className="skeleton h-6 w-24 animate-pulse rounded-full" />
                <div className="skeleton h-6 w-16 animate-pulse rounded-full" />
              </div>
              <div className="flex gap-3">
                <div className="skeleton h-5 w-20 animate-pulse rounded" />
                <div className="skeleton h-5 w-20 animate-pulse rounded" />
              </div>
            </div>
            <div className="skeleton h-10 w-32 animate-pulse self-center rounded md:self-end" />
          </div>
        </div>
      </div>
    </div>
